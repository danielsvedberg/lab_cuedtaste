...
def cuedtaste():
        ...
        while time.time() < endtime:
                while state == 0 and time.time() < endtime: #state 0: initialize/prime trigger
                ...
                while state == 1 and time.time() < endtime: #state 1: start trial/trip
                        if trig.isCrossed():
                                trig.killTone()
                                trigRun.value = 2
                                lines[line].playTone()
                ...
                while state == 2 and time.time() < endtime: #state 2: trigger trigger/prime reward
