"""
BUG: THE CODE IN LINES 184, 187, 190, 193 KEEPS LOOPING FOR THE TIME THE CUE PLAYS. All else is fine.
"""
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
if __name__ == "__main__":
    ...
    # state_m = 0 # keeps track of when the tone is played, makes sure it's played just once.
    ...
    while not done:
        ...
        # if signal.value == 0 and state_m == 0:
        if signal.value == 0:
            cue = cue_0
            pause_play(0)
            # state_m = 1
        ...
        # elif signal.value == 1 and state_m == 0:
        elif signal.value == 1:
            cue = cue_1
            pause_play(1)
            # state_m = 1
            # if state_m == 1:
        # elif signal.value == 2 and state_m == 0:
        elif signal.value == 2:
            cue = cue_2
            pause_play(2)
            # state_m = 1
            # if state_m == 1:
        # elif signal.value == 3 and state_m == 0:
        elif signal.value == 3:
            cue = cue_3
            pause_play(3)
            # state_m = 1
            # if state_m == 1:
        # elif signal.value == 4 and state_m == 0:
        elif signal.value == 4:
            cue = cue_4
            pause_play(4)
            # state_m = 1
            # if state_m == 1:
        # elif signal.value == 5 and state_m == 0: # added June 1
        elif signal.value == 5: # added June 1
            pg.mixer.stop()
