...
# class Block(pg.sprite.Sprite): <= pass something into the change_screen?
#     """
...
if __name__ == "__main__":
    ...
    # 06/16/21: play around with these values to get an idea of different directions/block shapes 
    # Try to also figure out a flashing screen
    cue_0 = Changescreen(BLACK, 1)
    #TODO 01/13/21: example of using load sound from pygame, implement for every cue
    cue_1 = Changescreen(RED, -4)
    cue_2 = Changescreen(BLUE, -3)
    cue_3 = Changescreen(GREEN, -2)
    cue_4 = Changescreen(ORANGE, -1)
    cue_5 = Changescreen(PURPLE, 0) 
