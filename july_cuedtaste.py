...
if __name__=="__main__":
    ...
    rew = NosePoke(36, 7)  # initialize "reward" nosepoke. "Rew" uses GPIO pins 38 as output for the light, and 11 as
    # input for the IR sensor. For the light, 1 = On, 0 = off. For the sensor, 1 = uncrossed, 0 = crossed.
    trig = Trigger(38, 29, 4, ser)  # initialize "trigger" trigger-class nosepoke. GPIO pin 38 = light output,
